...
INSERT INTO common_master (id,created_at,created_user_id,updated_at,updated_user_id,version,article_name,column_name,service_category,description,delete_flg) VALUES (8,'2018/9/19','COTOS','2018/9/19','COTOS',1,'解約理由','cancel_reason','2',null,0);
...
INSERT INTO common_master (id,created_at,created_user_id,updated_at,updated_user_id,version,article_name,column_name,service_category,description,delete_flg) VALUES (12,'2018/9/19','COTOS','2018/9/19','COTOS',1,'販社コード','branch_custoemr_cd','0',null,0);
...
ALTER SEQUENCE common_master_seq INCREMENT BY 16 NOCACHE;
